        ...
        Line()
            ...
            markpoint_opts=opts.MarkPointOpts(
                data=[  # 标记
                    ...
                    opts.MarkPointItem(name="预定冠军", coord=[xaxis_data[8], yaxis_data[8]])
                ]
            ),
        )
            .set_global_opts(
    ...
    chart_map = (
        Map()
            ...
            title_opts=opts.TitleOpts(
                title="2022年卡塔尔世界杯十六强疫苗接种 2022-12-10",
                pos_left="center",
                pos_top="top",
    ...
    line = (
        Line()
            ...
            markpoint_opts=opts.MarkPointOpts(
                data=[  # 标记
                    opts.MarkPointItem(type_="min"), opts.MarkPointItem(type_="max"),
                    opts.MarkPointItem(name="预定冠军", coord=[xaxis_data[9], yaxis_one_data[9]], value=yaxis_one_data[9])
                ]
            )
        )
    )
...
def first_run():
    ...
    #
    page = Page(page_title="2022年卡塔尔世界杯十六强疫苗接种 2022-12-10", layout=Page.DraggablePageLayout)
